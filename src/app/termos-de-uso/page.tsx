...
export const metadata: Metadata = {
  title: "Termos de Uso - Galeria Black Diaz",
  description: "Termos de uso completos da Galeria Black Diaz",
};
    ...
    <Container max="xl" className="p-5 pb-20">
      ...
      <Card as="section" className="mx-auto max-w-[1100px] leading-relaxed">
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          Ao acessar e utilizar a Galeria Black Diaz (&quot;Serviço&quot;,
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          A Galeria Black Diaz é uma plataforma educativa e gratuita que
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          ...
          constituem o acordo integral entre você e o projeto Galeria Black Diaz
          OSS.
        </p>
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          ...
          canais disponíveis no rodapé do Site (GitHub ou Email).
        </p>

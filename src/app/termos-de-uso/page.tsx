    ...
    <Container max="xl" className="p-5 pb-20">
      ...
      <Card as="section" className="mx-auto max-w-[1100px] leading-relaxed">
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          Ao acessar e utilizar a Galeria Black Diaz (&quot;Serviço&quot;, &quot;Site&quot;,
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          A Galeria Black Diaz é uma plataforma educativa e gratuita que disponibiliza recursos
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          ...
          integral entre você e o projeto Galeria Black Diaz OSS.
        </p>
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          ...
          no rodapé do Site (GitHub ou Email).
        </p>

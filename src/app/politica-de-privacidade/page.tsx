...
export const metadata: Metadata = {
  title: 'Política de Privacidade - Galeria Black Diaz',
    ...
    <Container max="xl" className="p-5 pb-20">
      ...
      <Card as="section" className="mx-auto max-w-[1100px] leading-relaxed">
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          A Galeria Black Diaz (&quot;nós&quot;, &quot;nosso&quot;) respeita sua privacidade e está
        ...
        <p className="mt-2 text-[var(--text-secondary)]">
          ...
          canais oficiais disponíveis no rodapé do site (GitHub ou Email).
        </p>
